...
import CarouselArrowLeft from "/src/assets/images/carousel-arrow-left.svg";
import CarouselArrowRight from "/src/assets/images/carousel-arrow-right.svg";
import CarouselImageOne from "/src/assets/images/carousel-image-1.svg";
import CarouselImageTwo from "/src/assets/images/carousel-image-2.svg";
import starIcon from "/src/assets/images/star-icon.svg";
import starOutlineIcon from "/src/assets/images/star-icon-outline.svg";
import ProductCardFavoriteIcon from "/src/assets/images/product-card-favorite-icon.svg";
import ProductCardCartIcon from "/src/assets/images/product-card-cart-icon.svg";
import ProductCardEyeIcon from "/src/assets/images/product-card-eye-icon.svg";
...
export default function ProductCard() {
  ...
  function ProductColors({bgColor}: {bgColor: string}) {
    return <div className={`w-[30px] h-[30px] rounded-full ${bgColor}`}></div>;
  }

  function ProductActionsBg({ image, altText }: { image: string; altText:string}) {
    return (
      <div className="w-[44px] h-[44px] flex items-center justify-center border border-[#E8E8E8] rounded-full">
  ...
  return (
    <section className="product-card-section w-[100%] h-[991px] lg:h-[598px] flex items-center justify-center">
      {/*Main Wrapper*/}
      <div className="main-wrapper w-[348px] h-[895px] lg:w-[1050px] lg:h-[550px] flex flex-col lg:flex-row justify-center gap-[30px]">
        {/*Image Card*/}
        <div className="image-card w-[348px] h-[394px] lg:w-[506px] lg:h-[546px] flex flex-col gap-[20px]">
          {/*Main Image Container*/}
          <div
            className="main-image-container w-[348px] h-[272px] lg:w-[506px] lg:h-[450px]
          ...
          >
            <div className="image-change-arrows-wrapper w-[348px] h-[155px] lg:w-[506px] lg:h-[195px] flex items-start justify-between px-[30px]">
        ...
        {/*Price Card*/}
        <div className="price-card w-[348px] lg:w-[510px] h-[471px] flex flex-col pl-[27px] lg: gap-[25px]">
          ...
          <div className="product-actions w-[298px] h-[44px] flex items-center gap-[10px]">
            <button className="w-[148px] h-[44px] py-[10px] px-[20px] bg-[#23A6F0] rounded-[5px] text-[14px] text-[white] leading-6 font-bold">
              Select Options
            </button>
