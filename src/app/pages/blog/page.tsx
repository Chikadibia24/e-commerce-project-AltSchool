import BlogCard from "@/app/components/blog-section/blog-card";

export default function Blog() {
  return (
    <section className="blog-section w-[100%] flex justify-center">
      {/* Wrapper Main */}
      <div className="wrapper-main w-[414px] h-[2100px] pb-[80px] lg:pb-[initial] lg:w-[1120px] lg:h-[900px] flex flex-col justify-center items-center gap-[80px]">
        {/* Wrapper Sub Main - 1 */}
